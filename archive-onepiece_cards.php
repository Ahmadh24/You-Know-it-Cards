<?php
/**
 * Archive template for One Piece Cards
 */
...
<div class="container">
    <div class="archive-header">
        <h1 class="archive-title">One Piece Cards</h1>
        <p class="archive-description">Explore our collection of One Piece trading cards</p>
    </div>
    ...
    <?php else : ?>
        <div class="no-cards">
            <h2>No One Piece Cards Found</h2>
            <p>Sorry, no One Piece cards are available at the moment. Check back soon!</p>
        </div>
    <?php endif; ?>
</div>
