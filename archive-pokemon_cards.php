<?php
/**
 * Archive template for Pokémon Cards
 */
...
<div class="container">
    <div class="archive-header">
        <h1 class="archive-title">Pokémon Cards</h1>
        <p class="archive-description">Explore our collection of Pokémon trading cards</p>
    </div>
    ...
    <?php if (have_posts()) : ?>
        ...
        $card_index = 0;
        ?>
        <div class="cards-grid pokemon-cards-grid">
            <?php while (have_posts()) : the_post(); ?>
                ...
                <div class="card-item">
                    ...
                    <div class="card-content">
                        <h3><a href="<?php echo esc_url($tiktok_url); ?>" target="_blank" rel="noopener noreferrer"><?php the_title(); ?></a></h3>
                        <p><?php the_excerpt(); ?></p>
    ...
    <?php else : ?>
        <div class="no-cards">
            <h2>No Pokémon Cards Found</h2>
            <p>Sorry, no Pokémon cards are available at the moment. Check back soon!</p>
        </div>
    <?php endif; ?>
</div>
