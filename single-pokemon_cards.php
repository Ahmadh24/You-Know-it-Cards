<?php
/**
 * Single template for Pokémon Cards
 */
                ...
                <div class="card-image-section">
                    ...
                    <div class="card-details-sidebar">
                        ...
                        <div class="card-actions">
                            <a href="<?php echo get_post_type_archive_link('pokemon_cards'); ?>" class="btn btn-secondary">Back to Collection</a>
                        ...
                        foreach ($related_cards as $card) {
                            ...
                            <div class="card-item">
                                ...
                                <div class="card-content">
                                    <h3><a href="<?php echo esc_url($tiktok_url); ?>" target="_blank" rel="noopener noreferrer"><?php echo get_the_title($card->ID); ?></a></h3>
